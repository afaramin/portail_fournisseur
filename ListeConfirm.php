...
echo "<TABLE   border='2'> <caption>liste des Commandes de :    " . $P3NFOU ;
echo "</caption>";
echo "<tr><th>commande</th><th>vos refs</th><th>article</th><th>libelle art</th><th>nos refs </th><th>Date</th><th>selection</th></tr>";

// la connexion a la BDD
include ("connexDB2.php");

$requet1 = "   with temp as ( SELECT p.adoc, p.alig , p.nart , P.lcdl , p.DCAR ,    p.ORFD , p.OLIG , c.vref , c.nref ,
...
$requet3 = "  ) select   t.adoc, t.vref , t.nref  , t.nart , t.lcdl , t.DCAR ,   t.ORFD , t.OLIG , t.alig   from temp   t 
